*** Settings ***
Library           ../../../resources/keywords/BB-INT-ETH-001.py
...
WiFi LAN Performance Test (Dynamic)
    ...
    Set Ephemeral Port Range    ${PC_LIST}    45220    45225   # make input
