*** Settings ***
Library           ../../../resources/keywords/BB-INT-ETH-002.py
...
WiFi LAN Performance Test (Dynamic)
    [Documentation]    Full ethernet performance validation per BB-INT-ETH-002
    [Tags]     BB-INT-ETH-002
    ...
    Log To Console               ==== Completed ethernet LAN Performance Test ====
    Log Message To Custom File   ==== Completed ethernet LAN Performance Test ====
