    ...
    def formfield_for_manytomany(self, db_field, request, **kwargs):
        if db_field.name == "user_permissions":
            qs = Permission.objects.all().exclude(
                content_type__app_label="test_management",
                content_type__model__in =  ["testsuiteexecutiondevice","scheduledexecution", "testcaseexecution", "executionartifact",]  # model name in lowercase
            )
